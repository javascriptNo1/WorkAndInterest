...
const classlay = [
  ...
  {
    maxclass: '职业',
    minclass: ['教师', 'up主', '主播', '工人', '记者', '演员', '厨师', '医生', '护士', '司机', '军人', '律师', '会计', '店员', '出纳', '作家', '导游', '警察', '歌手', '画家', '裁缝', '翻译', '法官', '保安', '程序员','服务员', '清洁工', '建筑师', '理发师', '采购员', '设计师', '消防员', '机修工', '推销员', '魔术师', '邮递员', '售货员', '救生员', '工程师', '飞行员', '管理员', '机械师', '经纪人','审计员', '漫画家', '园艺师', '科学家','主持人']
  },
  {
    maxclass: '综合',
    minclass: ['综合']
...
module.exports = {
  ...
  server:'https://www.wuzhenlu.cn/',
  // server: 'http://192.168.1.168/',
  classlay: classlay
}